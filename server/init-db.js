...
const initDb = async () => {
    try {
        ...
        const releaseColumns = [
            ...
            { name: 'pre_release_social_media', type: "VARCHAR(50) NULL" },
            { name: 'pre_release_youtube_music', type: "VARCHAR(50) NULL" },
            { name: 'genre', type: "VARCHAR(100)" },
            { name: 'sub_genre', type: "VARCHAR(100)" },
            { name: 'genre_id', type: "INT NULL" },
            { name: 'subgenre_id', type: "INT NULL" },
