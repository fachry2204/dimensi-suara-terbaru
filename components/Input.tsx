...
export const TextInput: React.FC<InputProps> = ({ label, className = '', ...props }) => (
  <div className="mb-4 group">
    ...
    <input 
      className={`w-full px-3 py-2 text-sm border border-gray-300 rounded bg-white shadow-sm text-black focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/20 placeholder-gray-400 transition-all duration-200 hover:border-blue-400 ${className}`}
      {...props}
    />
  </div>
);
