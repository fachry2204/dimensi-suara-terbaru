...
export default function PublishingPaymentsPage() {
    ...
    // Simulated Financial Data (Publishing Royalties)
    const balance = "Rp 12.440.000";
    const totalWithdrawn = "Rp 14.800.000";
    const lastWithdrawal = "Rp 3.080.000";

    const transactions: Transaction[] = [
        { id: "TX-P9012", date: "2026-06-08", amount: "Rp 3.080.000", status: 'Success', method: 'Bank Transfer (BCA)', recipient: '122-384-***8 (Arka G.)' },
        { id: "TX-P8904", date: "2026-05-10", amount: "Rp 5.390.000", status: 'Success', method: 'Bank Transfer (BCA)', recipient: '122-384-***8 (Arka G.)' },
        { id: "TX-P8721", date: "2026-04-12", amount: "Rp 6.330.000", status: 'Success', method: 'Bank Transfer (BCA)', recipient: '122-384-***8 (Arka G.)' }
    ];
    ...
    const handleRequestPayout = (e: React.FormEvent) => {
        ...
        setTimeout(() => {
            ...
            setAmount('');
            setAccountNum('');
            alert('Permintaan penarikan saldo royalti publishing berhasil dikirim. Admin akan segera memproses penarikan Anda.');
        }, 1500);
    };
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-slate-800 flex items-center gap-3 whitespace-nowrap">
                        ...
                        <span>Pembayaran Publishing</span>
                    </h1>
                    <p className="text-slate-500 text-sm mt-1">Kelola penarikan saldo royalti penciptaan lagu Anda</p>
                </div>
                <div>
                    <button 
            ...
            {isLoading ? (
                ...
                <>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        {[
                            { label: 'Saldo Royalti Tersedia', value: balance, icon: <ArrowDownLeft size={20} />, bg: 'bg-emerald-500/10 border-emerald-500/20 text-emerald-600', sub: 'Royalti yang bisa ditarik' },
                    ...
                    <div className="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden p-6 space-y-4">
                        <div>
                            <h2 className="text-base font-extrabold text-slate-800 uppercase tracking-wider">Riwayat Pembayaran Royalti</h2>
                            <p className="text-xs text-slate-400 mt-0.5">Semua rekaman pencairan royalti publishing Anda</p>
                        </div>
                ...
                <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden border border-slate-100 animate-fade-in-up">
                        <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
                            <h3 className="text-base font-extrabold text-slate-800 uppercase tracking-wider">Ajukan Penarikan Royalti</h3>
