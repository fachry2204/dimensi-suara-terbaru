...
export default function UserEditPage() {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      try {
        ...
        if (detail.role !== 'User') {
            // If not a regular user, redirect back to detail
        ...
        setFormData({
          ...
          kkt_file_path: detail.kkt_file_path,
  ...
  if (!user) {
    return (
      <div className="p-8 w-full max-w-none min-h-screen flex flex-col items-center justify-center">
        ...
        <button onClick={() => router.push('/users')} className="mt-4 text-blue-600 font-medium">Kembali ke Daftar User</button>
      </div>
    );
  }
  ...
  return (
    <div className="p-8 w-full max-w-none min-h-screen">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 space-y-8 animate-fade-in text-slate-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-1">
                    ...
                    <select
                        ...
                        className="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all bg-white text-slate-800"
                    >
