...
const adminCards = [
  ...
  },
  {
    ...
    href: "/admin/gateway",
    icon: Mail,
    description: "Pengaturan gateway SMTP Email, WhatsApp Gateway, dan template notifikasi user.",
    tone: "bg-teal-600",
    bgTone: "bg-teal-50 hover:bg-teal-100 border-teal-100/80 text-teal-950",
  },
  {
    title: "Statistik",
  ...
  },
  {
    ...
    href: "/admin/settings",
    icon: Settings,
    description: "Logo, role, kontrak, payment, backup, dan integrasi.",
    tone: "bg-slate-700",
