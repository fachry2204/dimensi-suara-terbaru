    ...
    <div className="space-y-8 p-2">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div className="flex gap-3">
          <Link href="/admin/publishing/writer" className="flex items-center gap-2 px-6 py-2.5 rounded-full text-sm font-semibold text-white shadow-lg shadow-[#aa91cc]/20 transition-all duration-300 hover:shadow-xl hover:-translate-y-0.5" style={{ background: getButtonColor() || '#aa91cc' }}>
            <UserPlus size={16} />
            Data Pencipta
          </Link>
          <Link href="/admin/publishing/songs" className="flex items-center gap-2 px-6 py-2.5 rounded-full text-sm font-semibold text-white shadow-lg shadow-violet-500/20 transition-all duration-300 hover:shadow-xl hover:-translate-y-0.5" style={{ background: '#7c3aed' }}>
            <ListMusic size={16} />
            Data Lagu
          </Link>
        </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
        <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
          ...
          <Link href="/admin/publishing/songs" className="text-sm font-semibold hover:underline" style={{ color: '#aa91cc' }}>
            Lihat Semua →
          </Link>
        </div>
